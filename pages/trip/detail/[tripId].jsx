        ...
        <Row>
          <Col lg="5">
            <Card style={{ width: "100%" }}>
                <img src={trip.trip_image}  alt="Trip Image" className={`img-fluid rounded shadow-4 ${styles.detail_trip_img}`} />                             
            </Card>
          </Col>
          <Col lg>
        ...
        <Row className="mt-3">
          <Col lg="4">
            ...
            <div className={styles.posted}>
                <img src={trip.avatar_url} alt="owner avatar" className={`img-fluid rounded-circle shadow-4 ${styles.image_profile}`}  />            
